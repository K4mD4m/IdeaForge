    ...
    <main className="min-h-screen bg-gradient-to-b from-[#0a0a0f] to-[#1a1a2e] text-white px-6 pt-24 pb-16 flex justify-center">
      <div className="w-full max-w-3xl">
        ...
        <section className="space-y-8 text-gray-300 leading-relaxed">
          <p>
            Welcome to <strong>IdeaForge</strong>. By creating an account, using
            our platform, or accessing any part of our services, you agree to
          ...
          <p>
            ...
            account. By registering, you confirm that you are at least 16 years
            old and that you have read and accepted these Terms.
          </p>

          <h2 className="text-2xl font-semibold">2. Use of the Platform</h2>
          <p>
            You agree to use IdeaForge only for lawful purposes. You may not
            upload, post, or share content that is illegal, harmful,
            threatening, abusive, defamatory, or infringes on intellectual
            property rights.
          </p>
          ...
          <p>
            ...
            IdeaForge, you grant us a non-exclusive, worldwide, royalty-free
            license to display, distribute, and promote your content as part of
            the service.
          </p>
          ...
          <p>
            ...
            platform after such changes means you accept the updated Terms.
          </p>
